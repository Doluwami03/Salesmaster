    ...
    <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="./dist/assets/img/user2-160x160.jpg" class="user-image rounded-circle shadow" alt="User Image"><a href="#" class="nav-link">
                        <?= $name ?></a>
                    <?php if ($admin == 1) { ?> <?php } ?>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                            ...
                            <li class="user-footer"> <a href="#" class="btn btn-default btn-flat">Profile</a>  <!--end::Menu Footer-->
                        </ul>
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a  class="brand-link"> <!--begin::Brand Image--> <img src="img/download.jpeg" alt="Livepetal logo" class="brand-image opacity-40 shadow " style="border-radius:20px;" > <!--end::Brand Image--> <!--begin::Brand Text--> <a class="navbar-brand" style="color: white; font-size:medium;" href="#"> <strong><?php if (isset($_COOKIE['biztitle'])) {
                                                echo strtoupper($_COOKIE['biztitle']);
                                                } ?></strong></a> <!--end::Brand Text--><!--end::Brand Link--> </div> <!--end::Sidebar Brand--> <!--begin::Sidebar Wrapper-->
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open"> <a href="dashboard.php" class="nav-link active"> <i class="nav-icon bi bi-speedometer"></i>
                                <p>
                                    Dashboard
                                </p>
                            </a>
                        ...
                        <li class="nav-item"> <a href="index.php" class="nav-link"> <i class="bi bi-tags-fill"></i>
                                <p>
                                    POS
                                </p>
                            </a>
                        ...
                        <li class="nav-item"> <a href="categories.php" class="nav-link"> <i class="bi bi-house"></i>
                                <p>
                                    Categories
                                </p>
                            </a>
                        </li>
                        <li class="nav-item"> <a href="transactions.php" class="nav-link"> <i class="bi bi-cash-stack"></i>
                                <p>
                                    Transactions
                                </p>
                            </a>
                        </li>
                        <li class="nav-item"> <a href="admin.php" class="nav-link"> <i class="bi bi-graph-up"></i>
                                <p>
                                   Tracks
                                </p>
                            </a>                            
                        </li>
                        <li class="nav-item"> <a href="product.php" class="nav-link"><i class="bi bi-shop store-icon"></i>
                                <p>
                                    Stores                                    
                                </p>
                            </a>
                        </li>
                        <li class="nav-item"> <a href="user.php" class="nav-link">
                        <i class="bi bi-person"></i>
                                ...
                                <li class="nav-item">
                                     <a href="?logout=true" class="nav-link"><i class="bi bi-box-arrow-right"></i> Logout</a>
                                </li> 
                            </a>
                        </li>
                </nav>
